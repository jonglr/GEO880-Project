...
![Figure 1: A visualization of the arranged plots of each attribute](Exports/grid_plot.png)
...
![Figure 2: Flow Diagram of Classification Model](Flow Diagram/Flow Diagram.png)
...
Figure 3 is an interactive map of the classification for a selected track (First Track in the Dataset). 
![Figure 3: Classified tracks](Exports/interactive_map.html)

For a full page map, click [here](Exports/interactive_map.html) . 

Figure 4 is a static map that visualizes the classified GPS tracks.

![Figure 4: Classified tracks](Exports/track_overall.png)
