...
```{r Classification Visualization, echo=FALSE}
# Function to create an interactive map
create_interactive_map2 <- function(classified_tracks) {
...
interactive_map <- create_interactive_map2(classified_tracks)

# Save the map as an HTML file
saveWidget(interactive_map, "interactive_map_single.html", selfcontained = TRUE)
```

```{r Static Visualization, echo=FALSE}
